...
Critical conceptual paper questioning whether AI-assisted literature review changes the *epistemic values* of the resulting scholarship. Direct counter-weight to the catalog's literature-synthesis projects ([`storm`](../../projects/storm.md), [`open-scholar`](../../projects/open-scholar.md), [`paper-qa`](../../projects/paper-qa.md)) — they answer 'how', this paper asks whether IS should.
