...
Jarvenpaa (UT Austin) and Klein (Münster) treat generative AI as a *theorizing partner*, not just a tool, and lay out an IS-research agenda for human-gAI theory development. Methodological reference for RISE pipelines that aim beyond data analysis toward conceptual contribution.
