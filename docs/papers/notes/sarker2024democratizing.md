...
Senior-scholar JAIS editorial (Sarker is editor-in-chief; Gopal, Thatcher, Susarla are AEs / senior figures) explicitly arguing that human-AI peer-review collaboration will reshape scholarly knowledge evaluation. Sets the IS-discipline agenda that the catalog's referee-simulation projects ([`ape`](../../projects/ape.md), [`reviewer`](../../projects/reviewer.md), [`marg`](../../projects/marg.md)) operationalize.
