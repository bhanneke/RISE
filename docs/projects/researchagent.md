...
- Baek, J. et al. (2024). [*ResearchAgent: Iterative Research Idea Generation over Scientific Literature with Large Language Models*](../papers/notes/baek2024researchagent.md) `baek2024researchagent`
