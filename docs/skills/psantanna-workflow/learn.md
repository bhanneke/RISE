<!-- DO NOT EDIT — auto-copied from skills/psantanna-workflow/details/learn.md -->

# `/learn`

*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `infra` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/learn/SKILL.md)*
