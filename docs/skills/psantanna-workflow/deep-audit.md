...
*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `audit` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/deep-audit/SKILL.md)*
