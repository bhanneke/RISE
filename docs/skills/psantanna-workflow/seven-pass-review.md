...
*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `review` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/seven-pass-review/SKILL.md)*
