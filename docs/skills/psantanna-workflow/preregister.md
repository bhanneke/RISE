...
*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `design` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/preregister/SKILL.md)*
