<!-- DO NOT EDIT — auto-copied from skills/psantanna-workflow/details/new-diagram.md -->

# `/new-diagram`

*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `figures` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/new-diagram/SKILL.md)*
