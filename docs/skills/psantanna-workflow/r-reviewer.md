<!-- DO NOT EDIT — auto-copied from skills/psantanna-workflow/details/r-reviewer.md -->

# `agent:r-reviewer`

*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `review` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/agents/r-reviewer.md)*
