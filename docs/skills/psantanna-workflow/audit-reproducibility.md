...
*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `replication` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/skills/audit-reproducibility/SKILL.md)*
