<!-- DO NOT EDIT — auto-copied from skills/psantanna-workflow/details/methods-referee.md -->

# `agent:methods-referee`

*Pack: [Pedro Sant'Anna's Claude Code Workflow](../psantanna-workflow.md) · category `review` · field `economics` · [source](https://github.com/pedrohcgs/claude-code-my-workflow/blob/main/.claude/agents/methods-referee.md)*
