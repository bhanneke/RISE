<!-- DO NOT EDIT — auto-copied from skills/theorist-toolbox/details/proof-readability.md -->
...
<div class="skill-card" style="background:#fafafa; border:1px solid #e0e0e0; border-radius:8px; padding:1em 1.2em; margin:1em 0 1.5em; font-size:0.95em;"><div style="display:flex; flex-wrap:wrap; gap:1em 2em; align-items:baseline;"><div><b>Pack:</b> <a href="../theorist-toolbox/">Theorist Toolbox</a></div><div><b>Category:</b> <code>editing</code></div><div><b>Field:</b> economics</div><div><b>License:</b> <code>MIT</code></div><div><b>Updated:</b> 2026-07</div></div><div style="margin-top:0.5em;"><b>Stages:</b> <code>revision-editing</code></div><div style="margin-top:0.8em;"><button onclick="navigator.clipboard.writeText(`gh api repos/morankor/theorist-toolbox/contents/skills/proof-readability/SKILL.md --jq .content | base64 -d`); this.textContent=&apos;&#x2713; copied&apos;;" style="background:#00897b; color:white; border:none; padding:0.4em 0.8em; border-radius:4px; cursor:pointer; font-size:0.9em; margin-right:0.5em;">&#128203; copy fetch command</button><button onclick="navigator.clipboard.writeText(&apos;https://bhanneke.github.io/RISE/skills/theorist-toolbox/proof-readability/&apos;); this.textContent=&apos;&#x2713; copied&apos;;" style="background:#fff; color:#333; border:1px solid #ccc; padding:0.4em 0.7em; border-radius:4px; cursor:pointer; font-size:0.9em;">&#128279; share link</button></div><div style="margin-top:0.6em; font-size:0.9em;"><a href="https://github.com/morankor/theorist-toolbox/blob/main/skills/proof-readability/SKILL.md" target="_blank" rel="noopener">&#8599; view SKILL.md on source</a> &middot; <img src="https://img.shields.io/github/stars/morankor/theorist-toolbox?style=flat" alt="GitHub stars" style="vertical-align:middle;"></div></div>
...
1. **Confirm verified status.** This skill assumes correctness is already established. If the proof has not been through a prover/review cycle (or the user hasn't vouched for it), say so and offer `math-proof` / the co-math pipeline instead.
...
8. **Report.** Summarize the edits grouped by layer, list the contested edits as proposals, and separately list (a) any spots where you suspected a mathematical gap and deliberately did **not** edit — these go back to the prover; (b) any expansion where you had to derive an intermediate line yourself — these need a correctness re-check, since even "obvious" filled-in algebra is new content. In a co-math project, suspected gaps mean the workstream returns to `prover`; the readability edit is re-reviewed by `paper-reviewer` for plumbing (references, compilation), not re-proved.
