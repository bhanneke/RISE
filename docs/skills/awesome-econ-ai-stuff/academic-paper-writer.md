<!-- DO NOT EDIT — auto-copied from skills/awesome-econ-ai-stuff/details/academic-paper-writer.md -->

# `academic-paper-writer`

*Pack: [awesome-econ-ai-stuff (Antonio Mele)](../awesome-econ-ai-stuff.md) · category `drafting` · field `economics` · [source](https://github.com/meleantonio/awesome-econ-ai-stuff/blob/main/_skills/writing/academic-paper-writer/SKILL.md)*
