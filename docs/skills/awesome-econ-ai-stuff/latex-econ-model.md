<!-- DO NOT EDIT — auto-copied from skills/awesome-econ-ai-stuff/details/latex-econ-model.md -->

# `latex-econ-model`

*Pack: [awesome-econ-ai-stuff (Antonio Mele)](../awesome-econ-ai-stuff.md) · category `modeling` · field `economics` · [source](https://github.com/meleantonio/awesome-econ-ai-stuff/blob/main/_skills/theory/latex-econ-model/SKILL.md)*
