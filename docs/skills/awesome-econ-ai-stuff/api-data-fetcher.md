<!-- DO NOT EDIT — auto-copied from skills/awesome-econ-ai-stuff/details/api-data-fetcher.md -->

# `api-data-fetcher`

*Pack: [awesome-econ-ai-stuff (Antonio Mele)](../awesome-econ-ai-stuff.md) · category `data-handling` · field `economics` · [source](https://github.com/meleantonio/awesome-econ-ai-stuff/blob/main/_skills/data/api-data-fetcher/SKILL.md)*
