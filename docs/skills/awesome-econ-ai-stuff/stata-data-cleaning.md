<!-- DO NOT EDIT — auto-copied from skills/awesome-econ-ai-stuff/details/stata-data-cleaning.md -->

# `stata-data-cleaning`

*Pack: [awesome-econ-ai-stuff (Antonio Mele)](../awesome-econ-ai-stuff.md) · category `data-handling` · field `economics` · [source](https://github.com/meleantonio/awesome-econ-ai-stuff/blob/main/_skills/data/stata-data-cleaning/SKILL.md)*
