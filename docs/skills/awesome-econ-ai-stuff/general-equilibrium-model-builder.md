...
*Pack: [awesome-econ-ai-stuff (Antonio Mele)](../awesome-econ-ai-stuff.md) · category `modeling` · field `economics` · [source](https://github.com/meleantonio/awesome-econ-ai-stuff/blob/main/_skills/theory/general-equilibrium-model-builder/SKILL.md)*
